...
for (const age of [-10, -1, 0, 1, 2, 2.5, 19, 98, 120, 121]) {
...
assert.match(api, /Number\.isInteger\(number\) && number >= 3 && number <= 18/);
assert.match(web, /numericAge < 3 \|\| numericAge > 18/);
